          ...
          {displayList.map((track) => {
            ...
            return (
              <div
                key={track.id}
                className={cn(
                  "group flex w-full items-center gap-3 rounded-xl px-3 py-2.5 transition-colors cursor-pointer",
              ...
              >
                ...
                <div className="relative size-10 shrink-0 overflow-hidden rounded-lg bg-muted">
                  {track.album_art_url && (
                    ...
                    <img src={track.album_art_url} alt="" className="h-full w-full object-cover" />
                  )}
                </div>
                ...
                <div className="min-w-0 flex-1">
                  ...
                  <p className="mt-0.5 truncate text-xs text-muted-foreground">
                    {track.artists.join(", ")}
                    {track.album_name && (
                      <span className="text-muted-foreground/50"> · {track.album_name}</span>
                    )}
                  </p>
                </div>
