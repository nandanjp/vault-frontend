        ...
        <Dialog open={open} onOpenChange={onOpenChange}>
            <DialogContent className="max-w-lg gap-0 p-0">
                ...
                <div className="flex items-center gap-3 px-5 pt-5 pb-2">
                    ...
                    <DialogClose className="mt-0.5 shrink-0 self-start" />
                </div>

                {/* Search — floating inside content area */}
                <div className="px-5 pb-3">
                    <div className="bg-muted/60 ring-border/50 flex items-center gap-2.5 rounded-xl px-3.5 py-2.5 ring-1">
                ...
                {hasFooter && (
                    <div className="bg-muted/40 flex items-center justify-between gap-3 rounded-b-2xl px-5 py-3.5">
                        {hasPagination ? (
