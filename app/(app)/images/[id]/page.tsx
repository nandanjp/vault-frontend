                        ...
                        {image.status === "ready" && (
                            <Button
                                ...
                                className={cn(
                                    "gap-2",
                                    image.is_favourited &&
                                        "border-rose-400/60 text-rose-500 hover:text-rose-500"
                                )}
                            ...
                            >
                                <Heart
                                    className={cn("size-4", image.is_favourited && "fill-rose-500")}
                                />
                        ...
                        <AlertDialog>
                            ...
                            <AlertDialogContent>
                                <AlertDialogHeader>
                                    ...
                                    <AlertDialogDescription>
                                        <span className="font-medium">{image.filename}</span> will
                                        be permanently deleted from storage and removed from all
                                        albums, stories, and favourites. This cannot be undone.
                                    </AlertDialogDescription>
                                </AlertDialogHeader>
                                <AlertDialogFooter>
                    ...
                    <div className="border-border bg-muted overflow-hidden rounded-xl border">
                        {isLoading ? (
                            ...
                            <div className="text-muted-foreground flex min-h-96 flex-col items-center justify-center gap-3">
                                <AlertCircle className="text-destructive/50 size-10" />
                                <p className="text-sm">Processing failed</p>
                                <p className="text-muted-foreground/70 text-xs">
                                    You can delete this image and try uploading again.
                                </p>
                            </div>
                        ) : (
                            <div className="text-muted-foreground flex min-h-96 flex-col items-center justify-center gap-3">
